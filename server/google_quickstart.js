...
function authorize(credentials, callback) {
  const {client_secret, client_id, redirect_uris} = credentials.web; // Had to change this from .installed to .web
  const oAuth2Client = new google.auth.OAuth2(
      client_id, client_secret, redirect_uris[0]); // Redirects to redirect_uris[0] after the user completes the authorization flow
